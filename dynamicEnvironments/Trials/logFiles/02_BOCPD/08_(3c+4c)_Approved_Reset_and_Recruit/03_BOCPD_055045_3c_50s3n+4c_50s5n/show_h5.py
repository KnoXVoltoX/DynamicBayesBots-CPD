...
if __name__ == "__main__":
    ...
    for i in range(0,h5_in['trial_1/params/num_trials'][...]):
        ...
        plt.savefig('Trial_'+str(i)+' Mean Decision of Robots.pdf')
        plt.close(fig="all")
        ...
        his1.bar_label(o, fontsize=labelsize)
        his1.set_ylim([0, 120])
        ...
        his2.bar_label(o, fontsize=labelsize)
        his2.set_ylim([0, 120])
        ...
        plt.tight_layout()
        plt.savefig('Trial_'+str(i)+' Histogram of Reset.pdf')
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('Trial_'+str(i)+' Histogram of Observation Samples Mean.pdf')
        except:
        ...
        ax1.legend();
        plt.title("Belief "+ str(data_set['params/num_robots'][...])+" Robots")
        plt.xlabel('Timestep [$t$]')
        plt.ylabel('Mean belief [$f$]')
        ...
        plt.savefig('Trial_'+str(i)+' Mean Belief of Robots.pdf')
        plt.close(fig="all")
